    ...
    def health(self):
        ...
        try:
            ...
            if final['suc']:
                ...
                logger.info('学号：{} 姓名：{} 打卡地点：{}-{} <打卡成功>'.format(self.info['userid'], self.info['username'], self.info['slocation'], self.info['location']))
        except:
...
if __name__ == '__main__':
    ...
    for s in infos:
        stu = Student_health()
        stu.username = s['username']
        stu.password = s['password']
